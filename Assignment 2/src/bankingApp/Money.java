...
public class Money implements Comparable {
	...
	public String toString() {
		// @TODO:  Fill in the code for this
		String ans = amount + " " + currency.getName();
		return ans;
	...
	public Money add(Money other) {
		// @TODO:  Fill in the code for this
		double toAdd = this.currency.valueInThisCurrency(other.amount, other.currency);
		double newAmount = this.amount + toAdd;
		Money newMoney = new Money(newAmount, this.currency);
		return newMoney;
	}
	...
	public Money subtract(Money other) {
		// @TODO:  Fill in the code for this
		double toSubtract = this.currency.valueInThisCurrency(other.amount, other.currency);
		double newAmount = this.amount - toSubtract;
		Money newMoney = new Money(newAmount, this.currency);
		return newMoney;
	}
	...
	public Money negate() {
		// @TODO:  Fill in the code for this
		double newAmount = 0 - this.amount;
		Money newMoney = new Money(newAmount, this.currency);
		return newMoney;
	}
	...
	public int compareTo(Object other) {
		...
		if (otherMoney.currency.getRate() == this.currency.getRate()) {
			return 0;
		} else if(otherMoney.currency.getRate() < this.currency.getRate()) {
			return 1;
		} else {
			return 2;
		}
